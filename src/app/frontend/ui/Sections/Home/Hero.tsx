...
function DesktopNavigation({ handleNavigationClick }: DesktopNavigationProps) {
  return (
      ...
      <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <a href="https://docs.resyncai.com" className="font-semibold text-indigo-600">
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            <span className="font-bold">reduce customer support</span> needs
            with Resync.
          </p>
